			...
			elements: [{
				...
				children: [{
					...
					children: [{
						...
						type: 'select',
						label: D.protocol,
						'default': WIKIDGLOBALS.BASE_URL + 'index.php/wkd/show/',
						items: [['page Wikid', WIKIDGLOBALS.BASE_URL + 'index.php/wkd/show/'], ['http://‎', 'http://'], ['https://‎', 'https://'], ['ftp://‎', 'ftp://'], ['news://‎', 'news://'], [E.other, '']],
						setup: function (F) {
						...
						onLoad: function () {
							...
							//console.info(this.getElement().getChildren().getItem(1).getChild(0).getChild(0).$);
							var $selectable_field_id = $(this.getElement().getChildren().getItem(1).getChild(0).getChild(0).$);
							$selectable_field_id.autocomplete({
