		...
		[
			{
				...
				description: "Un tableau composé d'une seule cellule.",
				html: '<table align="left" border="0" cellpadding="10" cellspacing="10" style="width: 400px; height: 300px; ">	<tbody>		<tr>			<td>				<p>					&nbsp;Ajoutez&nbsp;des cellules au tableau pour cr&eacute;er d&#39;autres cases, modifiez&nbsp;la taille du tableau,&nbsp;</p>			<p>					il est possible d&#39;agrandir la taille de la page, en angrandissant la fen&ecirc;tre de l&#39;&eacute;diteur.</p>			</td>		</tr>	</tbody></table>'
			},
			{
				title: 'Présentation Collection',
				description: 'Exemple de présentation des livres en ligne.',
