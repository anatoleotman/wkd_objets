...
(function ($) {
	var edit_mode_wrapper_prototype = {
		init: function (options, elem) {
			...
			this.$elem_contenu_ckeditable = ($('.contenu_wikid > .contenu_ckeditable').length) ? this.$elem_contenu_wikid.find('.contenu_ckeditable') : this.$elem_contenu_wikid;
		...
		handler_edit_mode: function (event) {
			this.$elem_contenu_ckeditable.hide();
		...
		_init_wikid_form_ajax: function () {
			...
			this.$wikid_form.ajaxForm({
				...
				success: function (ans) {
					this.$elem_contenu_ckeditable.html(ans); // on update avec le nouveau contenu
					this._close_ckeditor();
				},
				complete: function () {
					this.$elem.spin(false);
...
//					}
		...
		_close_ckeditor: function () {
			...
			// afficher le contenu
			this.$elem_contenu_ckeditable.show('scale');
